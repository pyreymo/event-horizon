...
internal sealed class PlayerPreviewPanel(
    ...
    Action<PlayerHandle?> setSelectedPlayer,
    IGameGui gameGui
)
{
    ...
    private PlayerHandle? routedSelectedPlayerEntityId;
    ...
    private void RouteSelectedPlayer(PlayerHandle? selectedPlayerEntityId)
    {
