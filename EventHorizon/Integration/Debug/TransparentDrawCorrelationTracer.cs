...
internal sealed unsafe class TransparentDrawCorrelationTracer : IDisposable
{
    ...
    private static void LogStandaloneSubmission(NativeGeometryStandaloneSubmission item)
    {
        ...
        DebugFileLog.Information(
            ...
            item.ModelParams,
            item.Model,
            item.OwnedModelFacade,
            item.SourceModelFlags,
            item.SourceMaterialCallback,
            item.SourceSkeleton,
            item.SourceRendererVariant,
            ...
            item.ShaderSelection,
            item.OffsetShaderSelection,
            item.ModelTypeSceneKey,
            item.DonorModelTypeValue,
            item.OffsetModelTypeValue,
            item.OwnedMaterial,
            item.OwnedMaterialResource,
            item.OwnedShaderPackage,
            item.OwnedMaterialConstantId,
            item.MaterialCaptured,
            item.MaterialLoaded,
            item.OwnedMaterialPath ?? "",
            item.SourceMaterialFlags,
            item.OwnedMaterialFlags,
            item.OwnedMaterialIndex,
            item.SourcePassMask,
            item.OwnedPassMask,
            item.SourceAuxiliaryViewMask,
            item.OwnedAuxiliaryViewMask,
            item.RendererSceneKeyCount,
            item.SubViewSceneKeyCount,
            item.View,
            item.SubView,
